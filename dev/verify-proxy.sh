...
try:
    ...
    vault = {}
vault.setdefault("SOC Proxy", {"username": "proxyuser", "password": "placeholder"})
...
timeout 90 "$PY" dev/auth-proxy.py 3128 proxyuser placeholder >dev/run/proxy.log 2>&1 & pids+=($!)
