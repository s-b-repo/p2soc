...
PANELS = [
    Panel(9001, "Panel 1 — Alerts",  "viewer1", "placeholder", hard_ttl=60),
    Panel(9002, "Panel 2 — Traffic", "viewer2", "placeholder"),
    Panel(9003, "Panel 3 — Firewall", "viewer3", "placeholder"),
    Panel(9004, "Panel 4 — Metrics", "viewer4", "placeholder", chart=True),
]
