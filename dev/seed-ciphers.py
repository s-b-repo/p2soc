...
KDF_ITERS = 600_000
ITEMS = [
    ("SOC Dev Panel 1", "viewer1", "placeholder", "http://127.0.0.1:9001"),
    ("SOC Dev Panel 2", "viewer2", "placeholder", "http://127.0.0.1:19102"),
    ("SOC Dev Panel 3", "viewer3", "placeholder", "http://127.0.0.1:9003"),
    ("SOC Dev Panel 4", "viewer4", "placeholder", "http://127.0.0.1:9004"),
]
