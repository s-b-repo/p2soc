...
./svpn-connect.sh --auth-only 203.0.113.100:3000 <username>

# 2) Full VPN tunnel (asks for root via pkexec/sudo to create the TUN device):
./svpn-connect.sh 203.0.113.100:3000 <username>

# With an auth domain:
./svpn-connect.sh 203.0.113.100:3000 <username> system
...
## Notes on the test gateway (203.0.113.100:3000)
